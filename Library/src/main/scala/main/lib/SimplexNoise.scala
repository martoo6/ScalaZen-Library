...
/** <code>SimplexNoise</code> contains the implementation
  ...
  */
trait SimplexNoise extends MathUtils{

  // Random offset values to prevent accidental aligning and grid artifacts
  val offset00 = 4491.073226372865897
  val offset01 = 7380.316654263014150
  val offset02 = 2552.639314613530870
  val offset03 = 6915.921394510744191
  val offset10 = 5500.907939704654918
  val offset11 = 5920.756836241091634
  val offset12 = 2943.023400629879511
  val offset13 = 4089.360492013645179
  val offset20 = 1344.189793725531315
  val offset21 = 2207.870305513515650
  val offset22 = 3460.732581098390910
  val offset23 = 8204.440182644025431
  val offset30 = 7883.998379525183195
  val offset31 = 4367.278070772598331
  val offset32 = 8458.071950524306615
  val offset33 = 3954.148706115616316
  ...
  //TODO: This ain't right as you can not repeat previous noises.
  ...
  val F1 = 1.4142135623730950488 //Math.sqrt(2.0)
  val G1 = 0.7071067811865475244 //1 / Math.sqrt(2.0)
  ...
  private val F2 = 0.36602540378443864676 //(Math.sqrt(3.0) - 1.0) / 2.0
  private val G2 = 0.21132486540518711775 //(3.0 - Math.sqrt(3.0)) / 6.0
  private val G22 = 0.57735026918962576451 //1 - 2.0 * (3.0 - Math.sqrt(3.0)) / 6.0
  ...
  private val F4 = 0.3090169943749474241 //(Math.sqrt(5.0) - 1.0) / 4.0
  private val G4 = 0.13819660112501051518 //(5.0 - Math.sqrt(5.0)) / 20.0
  private val G42 = 0.27639320225002103036 //2.0 * ((5.0 - Math.sqrt(5.0)) / 20.0)
  private val G43 = 0.41458980337503154554 //3.0 * ((5.0 - Math.sqrt(5.0)) / 20.0)
  private val G44 = 0.44721359549995793928 //1 - 4.0 * ((5.0 - Math.sqrt(5.0)) / 20.0)
